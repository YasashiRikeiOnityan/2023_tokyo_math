...
\begin{document}
    ...
    \section{解説}\label{解説1}
        \begin{enumerate}
            ...
            より式が複雑になってしまいそうです．ここまで来たら，$\dint{k\pi}{(k+1)\pi}\emabs{\sin{t}}\,dt=2$となることが示れば証明完了ですね．$\dint{k\pi}{(k+1)\pi}\emabs{\sin{t}}\,dt$は$y=\emabs{\sin{t}}$
            のうち，下図の斜線部のようにお山1つ分の面積と等しくなります．（お山1つ分の面積が2になることは覚えておきましょう！）}
            ...
            \textcolor{myBlue2}{そして，$1\leq x\leq 2$の範囲で$n$等分された長方形の横の長さを無限に小さくしていく（$n\to\infty$とする）と，
            ...
            \begin{align*}
                \dlim{n\to\infty}\bunsuu{1}{\sqrt{n}}\retuwa{k=n}{2n-1}\bunsuu{1}{\sqrt{(k+1)\pi}}&=\dlim{n\to\infty}\bunsuu{1}{\sqrt{n}}\retuwa{k=n+1}{2n}\bunsuu{1}{\sqrt{(k+1)\pi}}=\dlim{n\to\infty}\bunsuu{1}{n}\retuwa{k=n+1}{2n}\bunsuu{1}{\sqrt{(k/n)\pi}} \\
